      ...
      <div className="container relative mx-auto flex h-full flex-col items-center justify-center px-4 py-24 md:flex-row md:py-32">
        ...
        <div className="flex-1 space-y-8 text-center md:text-left">
          ...
          <div className="flex flex-col items-center gap-4 sm:flex-row md:justify-start">
            <Button variant="outline" size="lg" className="rounded-full px-8 py-6 text-lg  dark:text-white">
              Start Reading
            </Button>
            <Button
              variant="outline"
        ...
        <div className="mt-12 flex-1 md:mt-0">
          <div
            className={cn(
              "relative mx-auto h-104 w-124 rounded-2xl overflow-hidden",
          ...
          >
            <Image
              src="https://images.unsplash.com/photo-1515378791036-0648a3ef77b2?q=80&w=1170&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
